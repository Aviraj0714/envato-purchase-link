...
<html lang="en">
  <head>
      <meta charset="UTF-8">
      <title>Validate Envato Purchase Code - For Authors by shailygupta</title>
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row"><center>Copyright &copy; <?php echo date("Y") ?> shailygupta. <br> Powered by <a href="https://www.linkedin.com/in/shaily-gupta-120aa6251" target="_blank">shailygupta</a>, author of best selling <a href="https://codecanyon.net/item/pdf-viewer-for-wordpress/8182815/" target="_blank">PDF Viewer for WordPress plugin</a>. </center></div>
    </div><!-- /.container -->
